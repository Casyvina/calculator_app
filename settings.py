...
MATH_POSITIONS = {
    '/': {'col': 3, 'row': 2, 'character': '', 'operator': '/', 'image path': {'light': 'assets/divide_light.png', 'dark': 'assets/divide_dark.png'}},
...
OPERATORS = {
    ...
    'invert': {'col': 1, 'row': 2, 'text': '', 'image path': {'light': 'assets/invert_light.png', 'dark': 'assets/invert_dark.png'}},
